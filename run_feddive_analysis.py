...
# --- Experiment Definitions for FedDive testing ---
EXPERIMENTS_FEDDIVE_VQC_ANALYSIS = [
     {
    ...
    # --- BASELINE: FedAvg on Non-IID Data ---
    {
        "name": "VQC_Analysis_FedAvg_NonIID_Complex",
        "model": {"type": "vqc", "n_qubits": 4, "n_layers": 2, "circuit_type": "complex", "device": "lightning.qubit"},
        "data_config": {"name": "breast_cancer", "pca_features": 4, "scaling": "minmax"},
        "data_partition": {"iid": False, "alpha": 0.3}, # Challenging Non-IID
        "aggregation_overrides": {"strategy": "FedAvg"},
        "client_overrides": {"client": {"local_epochs": 3}, "optimization": {"learning_rate": 0.005, "optimizer": {"name": "Adam"}}},
        "server_overrides": {"server": {"num_rounds": 10}, "client_management": {"num_clients": 5}} # More rounds for better convergence view
    },
    # --- TEST: FedDive on Non-IID Data (Expected Winner) ---
    {
        "name": "VQC_Analysis_FedDive_NonIID_Complex",
        "model": {"type": "vqc", "n_qubits": 4, "n_layers": 2, "circuit_type": "complex", "device": "lightning.qubit"},
        "data_config": {"name": "breast_cancer", "pca_features": 4, "scaling": "minmax"},
        "data_partition": {"iid": False, "alpha": 0.3},
        "aggregation_overrides": {"type": "feddive", "momentum": 0.9, "temperature": 1.0}, # Test FedDive here
        "client_overrides": {"client": {"local_epochs": 3}, "optimization": {"learning_rate": 0.005, "optimizer": {"name": "Adam"}}},
        "server_overrides": {"server": {"num_rounds": 10}, "client_management": {"num_clients": 5}}
    },
    
    # --- CONTROL 1: Does FedDive help simpler circuits? ---
    {
        "name": "VQC_Analysis_FedAvg_NonIID_Basic",
        "model": {"type": "vqc", "n_qubits": 4, "n_layers": 2, "circuit_type": "basic", "device": "lightning.qubit"}, # Simpler circuit
        "data_config": {"name": "breast_cancer", "pca_features": 4, "scaling": "minmax"},
        "data_partition": {"iid": False, "alpha": 0.3},
        "aggregation_overrides": {"strategy": "FedAvg"},
        "client_overrides": {"client": {"local_epochs": 3}, "optimization": {"learning_rate": 0.005, "optimizer": {"name": "Adam"}}},
    ...
    {
        "name": "VQC_Analysis_FedDive_NonIID_Basic",
        "model": {"type": "vqc", "n_qubits": 4, "n_layers": 2, "circuit_type": "basic", "device": "lightning.qubit"},
        "data_config": {"name": "breast_cancer", "pca_features": 4, "scaling": "minmax"},
        "data_partition": {"iid": False, "alpha": 0.3},
    ...
    # --- CONTROL 2: Is FedDive's advantage specific to Non-IID? (Sanity Check) ---
    {
        "name": "VQC_Analysis_FedAvg_IID_Complex",
        "model": {"type": "vqc", "n_qubits": 4, "n_layers": 2, "circuit_type": "complex", "device": "lightning.qubit"},
        "data_config": {"name": "breast_cancer", "pca_features": 4, "scaling": "minmax"},
        "data_partition": {"iid": True}, # IID data
        "aggregation_overrides": {"strategy": "FedAvg"},
        "client_overrides": {"client": {"local_epochs": 3}, "optimization": {"learning_rate": 0.005, "optimizer": {"name": "Adam"}}},
        "server_overrides": {"server": {"num_rounds": 10}, "client_management": {"num_clients": 5}}
    },
    {
        "name": "VQC_Analysis_FedDive_IID_Complex",
        "model": {"type": "vqc", "n_qubits": 4, "n_layers": 2, "circuit_type": "complex", "device": "lightning.qubit"},
        "data_config": {"name": "breast_cancer", "pca_features": 4, "scaling": "minmax"},
        "data_partition": {"iid": True},
        "aggregation_overrides": {"type": "feddive", "momentum": 0.9, "temperature": 1.0},
...
if __name__ == "__main__":
    ...
    results = run_all_bc_experiments(EXPERIMENTS_FEDDIVE_VQC_ANALYSIS) # Uncomment to run all experimentsy
