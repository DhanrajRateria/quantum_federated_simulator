...
EXPERIMENTS_TO_RUN = [
    # # =================================================================================
    # # == Goal 1: Baseline Comparison on IID Data (Breast Cancer Dataset)
    # # == Objective: Ensure FedDive performs on par with FedAvg in the simplest case.
    # # =================================================================================
    # {
    #     "name": "BC_IID_FedAvg",
    #     "model": {"type": "classical_mlp", "hidden_dim": 64},
    #     "data_config": {"name": "breast_cancer"},
    #     "data_partition": {"iid": True},
    #     "aggregation_overrides": {"type": "fedavg"},
    #     "client_overrides": {"client": {"local_epochs": 5}, "optimization": {"learning_rate": 0.001}},
    #     "server_overrides": {"server": {"num_rounds": 20}, "client_management": {"num_clients": 10}}
    # },
    # {
    #     "name": "BC_IID_FedDive",
    #     "model": {"type": "classical_mlp", "hidden_dim": 64},
    #     "data_config": {"name": "breast_cancer"},
    #     "data_partition": {"iid": True},
    #     "aggregation_overrides": {"type": "feddive", "momentum": 0.9, "temperature": 1.0},
    #     "client_overrides": {"client": {"local_epochs": 5}, "optimization": {"learning_rate": 0.001}},
    #     "server_overrides": {"server": {"num_rounds": 20}, "client_management": {"num_clients": 10}}
    # },
    
    # # =================================================================================
    # # == Goal 2: Performance on Non-IID Data (Digits Dataset)
    # # == Objective: Show FedDive's advantage in heterogeneous environments.
    # # == We use the 'digits' dataset (10 classes) and a low alpha for high skew.
    # # =================================================================================
    # {
    #     "name": "Digits_NonIID_FedAvg",
    #     "model": {"type": "classical_mlp", "hidden_dim": 128},
    #     "data_config": {"name": "digits", "pca_features": 32},
    #     "data_partition": {"iid": False, "alpha": 0.1}, # Highly skewed
    #     "aggregation_overrides": {"type": "fedavg"},
    #     "client_overrides": {"client": {"local_epochs": 5}, "optimization": {"learning_rate": 0.01}},
    #     "server_overrides": {"server": {"num_rounds": 40}, "client_management": {"num_clients": 10}}
    # },
    # {
    #     "name": "Digits_NonIID_FedProx",
    #     "model": {"type": "classical_mlp", "hidden_dim": 128},
    #     "data_config": {"name": "digits", "pca_features": 32},
    #     "data_partition": {"iid": False, "alpha": 0.1},
    ...
    # },
    # {
    #     "name": "Digits_NonIID_FedDive",
    #     "model": {"type": "classical_mlp", "hidden_dim": 128},
    #     "data_config": {"name": "digits", "pca_features": 32},
    #     "data_partition": {"iid": False, "alpha": 0.1},
    #     "aggregation_overrides": {"type": "feddive", "momentum": 0.9, "temperature": 0.5},
    #     "client_overrides": {"client": {"local_epochs": 5}, "optimization": {"learning_rate": 0.01}},
    #     "server_overrides": {"server": {"num_rounds": 40}, "client_management": {"num_clients": 10}}
    # },

    # # =================================================================================
    # # == Goal 3: Robustness to Outliers/Noisy Clients (Breast Cancer Dataset)
    # # == Objective: Test how algorithms handle one faulty client. We make client 0 noisy.
    # # =================================================================================
    # {
    #     "name": "BC_NoisyClient_FedAvg",
    #     "model": {"type": "classical_mlp", "hidden_dim": 64},
    #     "data_config": {"name": "breast_cancer"},
    #     "data_partition": {"iid": True},
    #     "aggregation_overrides": {"type": "fedavg"},
    #     "client_overrides": {"client": {"type": "noisy", "noise_level": 0.5, "local_epochs": 5}, "optimization": {"learning_rate": 0.001}},
    #     "server_overrides": {"server": {"num_rounds": 20}, "client_management": {"num_clients": 10}}
    # },
    # {
    #     "name": "BC_NoisyClient_Median",
    #     "model": {"type": "classical_mlp", "hidden_dim": 64},
    #     "data_config": {"name": "breast_cancer"},
    #     "data_partition": {"iid": True},
    #     "aggregation_overrides": {"type": "median"},
    #     "client_overrides": {"client": {"type": "noisy", "noise_level": 0.5, "local_epochs": 5}, "optimization": {"learning_rate": 0.001}},
    #     "server_overrides": {"server": {"num_rounds": 20}, "client_management": {"num_clients": 10}}
    # },
    # {
    #     "name": "BC_NoisyClient_FedDive_Aggressive",
    #     "model": {"type": "classical_mlp", "hidden_dim": 64},
    #     "data_config": {"name": "breast_cancer"},
    #     "data_partition": {"iid": True},
    #     "aggregation_overrides": {"type": "feddive", "momentum": 0.9, "temperature": 0.1}, # Low temp -> aggressively follows outlier
    #     "client_overrides": {"client": {"type": "noisy", "noise_level": 0.5, "local_epochs": 5}, "optimization": {"learning_rate": 0.001}},
    #     "server_overrides": {"server": {"num_rounds": 20}, "client_management": {"num_clients": 10}}
    # },
    # {
    #     "name": "BC_NoisyClient_FedDive_Cautious",
    #     "model": {"type": "classical_mlp", "hidden_dim": 64},
    #     "data_config": {"name": "breast_cancer"},
    #     "data_partition": {"iid": True},
    #     "aggregation_overrides": {"type": "feddive", "momentum": 0.9, "temperature": 10.0}, # High temp -> ignores outlier
    #     "client_overrides": {"client": {"type": "noisy", "noise_level": 0.5, "local_epochs": 5}, "optimization": {"learning_rate": 0.001}},
    #     "server_overrides": {"server": {"num_rounds": 20}, "client_management": {"num_clients": 10}}
    # },

    # # =================================================================================
    # # == Goal 4: Hyperparameter Ablation Study (Digits Non-IID)
    # # == Objective: Understand the impact of momentum and temperature.
    # # =================================================================================
    # {
    #     "name": "Digits_NonIID_FedDive_LowMomentum",
    #     "model": {"type": "classical_mlp", "hidden_dim": 128},
    #     "data_config": {"name": "digits", "pca_features": 32},
    #     "data_partition": {"iid": False, "alpha": 0.1},
    #     "aggregation_overrides": {"type": "feddive", "momentum": 0.1, "temperature": 0.5}, # Low momentum
    #     "client_overrides": {"client": {"local_epochs": 5}, "optimization": {"learning_rate": 0.01}},
    #     "server_overrides": {"server": {"num_rounds": 40}, "client_management": {"num_clients": 10}}
    # },
    # {
    #     "name": "Digits_NonIID_FedDive_HighTemp",
    #     "model": {"type": "classical_mlp", "hidden_dim": 128},
    #     "data_config": {"name": "digits", "pca_features": 32},
    #     "data_partition": {"iid": False, "alpha": 0.1},
    #     "aggregation_overrides": {"type": "feddive", "momentum": 0.9, "temperature": 10.0}, # High temp
    #     "client_overrides": {"client": {"local_epochs": 5}, "optimization": {"learning_rate": 0.01}},
    #     "server_overrides": {"server": {"num_rounds": 40}, "client_management": {"num_clients": 10}}
    # },
    # =================================================================================
    # == Goal 5: CIFAR-10 Non-IID Experiments
    # == Objective: Test FedDive on a more complex dataset with non-IID partitioning.
    # =================================================================================
    {
    "name": "CNN_CIFAR10_NonIID_FedAvg",
    "model": {"type": "cnn"}, # Use the new CNN model
    "data_config": {"name": "cifar10"},
    "data_partition": {"iid": False, "alpha": 0.3},
    "aggregation_overrides": {"type": "fedavg"},
    "client_overrides": {
        "client": {"local_epochs": 3}, # 3 local epochs is a good start for CNNs
        "optimization": {"learning_rate": 0.001, "optimizer": {"name": "Adam"}}
    },
    "server_overrides": {"server": {"num_rounds": 50}, "client_management": {"num_clients": 10}}
},
{
    "name": "CNN_CIFAR10_NonIID_FedProx",
    "model": {"type": "cnn"},
    "data_config": {"name": "cifar10"},
    "data_partition": {"iid": False, "alpha": 0.3},
    "aggregation_overrides": {"type": "fedprox"},
...
{
    "name": "CNN_CIFAR10_NonIID_FedDive",
    "model": {"type": "cnn"},
    "data_config": {"name": "cifar10"},
    "data_partition": {"iid": False, "alpha": 0.3},
    "aggregation_overrides": {"type": "feddive", "momentum": 0.9, "temperature": 1.0},
